...
// Delete provides a mock function with given fields: certificateArn
func (_m *Certificate) Delete(certificateArn string) error {
	ret := _m.Called(certificateArn)

	var r0 error
	if rf, ok := ret.Get(0).(func(string) error); ok {
		r0 = rf(certificateArn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Certificate) Request(_a0 string, _a1 []string) (string, error) {
	ret := _m.Called(_a0, _a1)
